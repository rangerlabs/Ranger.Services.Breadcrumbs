...
namespace Ranger.Services.Breadcrumbs
{
    public class InitializeTenantHandler : ICommandHandler<InitializeTenant>
    {
        ...
        private readonly ILoginRoleRepository<BreadcrumbsDbContext> loginRoleRepository;
        private readonly BreadcrumbsDbContext identityDbContext;
        private readonly ILogger<InitializeTenantHandler> logger;

        public InitializeTenantHandler(IBusPublisher busPublisher, ILoginRoleRepository<BreadcrumbsDbContext> loginRoleRepository, BreadcrumbsDbContext identityDbContext, ILogger<InitializeTenantHandler> logger)
        {
        ...
        public async Task HandleAsync(InitializeTenant command, ICorrelationContext context)
        {
            ...
            logger.LogInformation($"New Breadcrumb tenant initialized successfully.");
