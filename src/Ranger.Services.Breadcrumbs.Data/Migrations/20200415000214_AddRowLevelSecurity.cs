...
namespace Ranger.Services.Breadcrumbs.Data.Migrations
{
    public partial class AddRowLevelSecurity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("CREATE UNIQUE INDEX idx_data_integrationid_version ON integration_streams (tenant_id, (data->>'IntegrationId'), version);");
            migrationBuilder.Sql("CREATE INDEX idx_data_name ON integration_streams (tenant_id, (data->>'Name'), (data->>'ProjectId'), (data->>'IntegrationId'));");
        }
